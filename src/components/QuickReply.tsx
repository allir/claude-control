      ...
      {isPermissionPrompt ? (
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="h-8 w-8 flex items-center justify-center rounded-lg bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.07] text-zinc-500 hover:text-zinc-300 transition-colors"
            title="Type a reply instead"
          >
